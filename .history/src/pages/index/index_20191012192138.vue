...
import { getHomeData, getRecommend, getFreeRead, getHotBook, getUserOpenId } from '@/api/index'
import { getSetting, getUserInfo, setStorageSync, getStorageSync, getOpenId } from '@/api/wechat'
