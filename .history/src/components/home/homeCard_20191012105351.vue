    ...
    <div class="home-card-inner">
      ...
      <div class="book-info">
        <div class="book-wraper">
          <div class="book-img-wraper" v-for="(item,index) in bookList">
            <ImageView  :src='bookList.cover' height='101px' />
          </div>
...
export default {
  ...
  computed:{
    ...
    bookList(){
      return this.data && this.data.userInfo && this.data.userInfo.bookList
    }
  },
  methods:{
    gotoShelf(){},
