    ...
    <div class="home-card-inner">
      ...
      <div class="book-info">
        <div class="book-wraper">
          <div class="book-img-wraper" v-for="item in bookList" :key="item.id">
            <ImageView  :src='item.cover' height='101px'  @click="onBookClick"/>
          </div>
        </div>
...
export default {
  ...
  computed:{
    avatar(){
      return (this.data && this.data.userInfo && this.data.userInfo.avatarU) || ''
    },
    nickname(){
